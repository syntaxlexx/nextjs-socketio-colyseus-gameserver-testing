import { Connection } from '.pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/Connection';
import { Serializer } from '.pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/serializer/Serializer';
import { Schema } from '@colyseus/schema';
import { SchemaConstructor } from '.pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/serializer/SchemaSerializer';
...
export declare class Room<State = any> {
    ...
    onStateChange: {
        ...
        clear: () => void;
    } & ((this: any, cb: (state: State) => void) => import(".pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/core/signal").EventEmitter<(state: State) => void>);
    onError: {
        ...
        clear: () => void;
    } & ((this: any, cb: (code: number, message?: string) => void) => import(".pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/core/signal").EventEmitter<(code: number, message?: string) => void>);
    onLeave: {
        ...
        clear: () => void;
    } & ((this: any, cb: (code: number) => void) => import(".pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/core/signal").EventEmitter<(code: number) => void>);
    protected onJoin: {
        ...
        clear: () => void;
    } & ((this: any, cb: (...args: any[]) => void | Promise<any>) => import(".pnpm/colyseus.js@0.15.13/node_modules/colyseus.js/lib/core/signal").EventEmitter<(...args: any[]) => void | Promise<any>>);
    serializerId: string;
