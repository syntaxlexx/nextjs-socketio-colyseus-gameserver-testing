import { OPERATION } from '.pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/spec';
import { ClientWithSessionId, Context, SchemaDefinition, DefinitionType } from ".pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/annotations";
import type { Iterator } from ".pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/encoding/decode";
import { ArraySchema } from ".pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/types/ArraySchema";
import { MapSchema } from ".pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/types/MapSchema";
import { ChangeTree, Ref } from ".pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/changes/ChangeTree";
import { NonFunctionPropNames, ToJSON } from '.pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/types/HelperTypes';
...
export declare abstract class Schema {
    ...
    clone(): this;
    toJSON(): Partial<import(".pnpm/@colyseus+schema@2.0.15/node_modules/@colyseus/schema/lib/types/HelperTypes").NonFunctionProps<{ [K in keyof this]: this[K] extends MapSchema<infer U, string> ? Record<string, U> : this[K] extends ArraySchema<infer U_1> ? U_1[] : this[K]; }>>;
